                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-6 mt-2">
                    ...
                    <div className="relative">
                      ...
                      {menuOpenId === op.id && (
                        <div className="absolute right-0 mt-1 w-40 bg-surface-container-low border border-outline-variant/20 rounded-xl shadow-xl z-10">
                          <button
                            onClick={() => {
                              setMenuOpenId(null);
                              openEdit(op);
            ...
            <div className="p-6 overflow-y-auto space-y-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onBlur={() => {
                    const normalized = normalizeWhatsappPhone(editWhatsapp);
                    if (normalized.ok) setEditWhatsapp(normalized.value);
                  }}
                  className="w-full bg-surface-container-highest p-4 rounded-xl text-sm font-medium text-on-surface outline-none border border-transparent focus:border-primary/30"
                />
              </div>
